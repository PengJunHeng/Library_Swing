...
public class BookBackPanel extends JPanel implements ActionListener {
	...
	public BookBackPanel(String sessionName) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == finishButton) {
			BookBackPanel bookBorrowPanel = new BookBackPanel();
