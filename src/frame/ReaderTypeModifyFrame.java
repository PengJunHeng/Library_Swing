...
public class ReaderTypeModifyFrame extends JFrame implements ActionListener {
	...
	public ReaderTypeModifyFrame(ReaderTypeForm newReaderTypeForm) {
		// TODO Auto-generated constructor stub

		this();
		this.readerTypeForm = newReaderTypeForm;
		if (readerTypeForm != null) {

			nameField.setText(readerTypeForm.getName());
			numberField.setText(String.valueOf(readerTypeForm.getNumber()));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == saveButton) {
			...
			readerTypeForm.setId(this.readerTypeForm.getId());
			readerTypeForm.setName(nameField.getText());
			readerTypeForm.setNumber(Integer.parseInt(numberField.getText()));
			int a = readerTypeDAO.update(readerTypeForm);
			if (a == 0) {
				JOptionPane.showMessageDialog(null, "读者类型信息修改失败！");

			} else {
				JOptionPane.showMessageDialog(null, "读者类型信息修改成功！");
			}
