...
public class BookTypeModifyFrame extends JFrame implements ActionListener {
	...
	public BookTypeModifyFrame(BookTypeForm bookTypeForm) {
		// TODO Auto-generated constructor stub
		this();
		this.bookTypeForm=bookTypeForm;
		nameField.setText(bookTypeForm.getTypeName());
		numberField.setText(""+bookTypeForm.getDays());
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == saveButton) {
			...
			if (ret == 0) {
				JOptionPane.showMessageDialog(null, "修改图书类型信息失败！");
				return;
			} else {
				JOptionPane.showMessageDialog(null, "修改图书类型信息成功！");
			}
