...
public class AddReaderFrame extends JFrame implements ActionListener {
...
//	String[] value=new String[2];
	...
	public AddReaderFrame() {
		...
		operatorLabel.setBounds(14, 292, 72, 18);
		...
		phoneField.setBounds(85, 258, 293, 24);
		contentPane.add(phoneField);

		emailField = new JTextField();
		emailField.setColumns(10);
		emailField.setBounds(85, 289, 293, 24);
		contentPane.add(emailField);

		remarkTextArea = new JTextArea();
		remarkTextArea.setBounds(85, 323, 293, 96);
	...
	public AddReaderFrame(String manager) {
