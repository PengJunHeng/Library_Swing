...
public class ModifyBookInfoFrame extends JFrame implements ActionListener {
...
//	String[] value=new String[2];
	...
	public ModifyBookInfoFrame() {
		...
		bookCaseCombo = new JComboBox(new Object[] {});
	...
	public ModifyBookInfoFrame(String manager2, BookForm newBookForm) {
					...
					if (coll_bookcase == null || coll_bookcase.isEmpty()) {
						...
						if (coll_pub == null || coll_pub.isEmpty()) {
							...
							Iterator it_pub = coll_pub.iterator();
							 isbn = "";
							String pubname = "";
							BookForm bookForm = bookDAO.queryM(newBookForm);
							...
							while (it_type.hasNext()) {
								...
								bookTypeCombo.addItem(typename1);
							}
							authorField.setText(author);
							transerField.setText(translator);
							...
							pageField.setText(String.valueOf(pages));
